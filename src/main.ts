...
const INITIAL_VISIBLE_GAME_COUNT = 24
const VISIBLE_GAME_INCREMENT = 24
const COMPACT_VISIBLE_GAME_COUNT = 24
const COMPACT_VISIBLE_GAME_INCREMENT = 24
...
function renderNow() {
  ...
  document.getElementById('app-pre-logo')?.remove()
